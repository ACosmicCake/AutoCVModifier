...
* You are utilising an Windows virtual machine using {platform.machine()} architecture with internet access.
...
* The current date is {datetime.today().strftime(f"%A, %B {datetime.today().day}, %Y")}.
</SYSTEM_CAPABILITY>
